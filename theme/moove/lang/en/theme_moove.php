...
$string['numbersfrontpagecontentdefault'] = '<h2>Base de aprendizado</h2>
                    <p>Aprenda sobre o sistema Altimus<br class="d-none d-sm-block d-md-none d-xl-block">
                        solicite cursos especificos para seu consultor <br class="d-none d-sm-block d-md-none d-xl-block">
                        </p>';
