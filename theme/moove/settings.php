...
if ($ADMIN->fulltree) {
    ...
    */
    ...
    $setting = new admin_setting_configcolourpicker($name, $title, $description, 'transparent');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    */
    ...
    if ($displaymarketingbox) {
        ...
        $default = '
        Bem Vindo a Universidade Altimus!
        A Universidade Altimus foi criada para auxiliar você na busca por informações, resoluções de dúvidas sobre o produto, ajudar a configurar recursos quando necessário e trazer conhecimentos relevantes sobre o sistema..';
