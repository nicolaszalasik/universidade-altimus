...
/**
 * Strings for component 'auth_none', language 'br'.
 *
 * @package   auth_altimus
 * @copyright 2021 onwards Altimus  {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['auth_nonedescription'] = 'Users can sign in and create valid accounts immediately, with no authentication against an external server and no confirmation via email.  Be careful using this option - think of the security and administration problems this could cause.';
$string['pluginname'] = 'Altimus';
...
$string['checknoauth'] = 'Não autenticadp';
$string['checknoauthok'] = 'Autenticação desabilitada.';
